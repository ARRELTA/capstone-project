      ...
      <div class="login-container w-container">
        ...
        <div class="form-block w-form">
          <form id="wf-form-Tourn-Create-Form" name="wf-form-Tourney-Creation-Form" data-name="Tourney Creation Form" method="post" class="form registration-form">
            <div id="w-node-_8d5d83a4-a27b-4fac-0296-7102b3651e5b-a3c4f7b9" class="registration-divider tournament-divider"><label for="Tournament-ID" class="field-label">Tournament ID</label><input type="number" class="login-field id-field w-input" maxlength="256" name="Tournament-ID" data-name="Tournament ID" placeholder="" id="Tournament-ID" required=""></div>
            <div class="w-layout-grid grid-3 edit-grid">
              <div id="w-node-ef20ee92-3eaf-930c-1162-18f4746b3517-a3c4f7b9" class="registration-divider tournament-divider"><label for="Tourney-Title" class="field-label">Title</label><input type="text" class="login-field w-input" maxlength="256" name="Tourney-Title" data-name="Tourney-Title" placeholder="e.g. John" id="Tourney-Title" required=""></div>
              <div id="w-node-_8103de59-c632-97d3-9531-640b9672d9a6-a3c4f7b9" class="registration-divider tournament-divider"><label for="Tourney-Type" class="field-label">Type</label><select id="Tourney-Type" name="Tourney-Type" data-name="Tourney-Type" required="" class="select-field w-select">
              ...
              <div id="w-node-_2ac18de0-5515-bfe0-0005-1ab538d87c0b-a3c4f7b9" class="registration-divider tournament-divider"><label for="StartTime_HH" class="field-label">Start Time</label>
                <div class="w-layout-grid grid-4"><input type="number" class="login-field duration-field w-node-_2ac18de0-5515-bfe0-0005-1ab538d87c12-a3c4f7b9 w-input" maxlength="256" name="StartTime_DD" data-name="StartTime_DD" placeholder="DD" id="StartTime_DD-2" required=""><input type="number" class="login-field duration-field w-node-c7c5ca6a-26eb-85a7-1e3e-d034b85d7bde-a3c4f7b9 w-input" maxlength="256" name="StartTime_MM" data-name="StartTime_MM" placeholder="MM" id="StartTime_MM-2" required=""><input type="number" class="login-field year-field w-node-d37991c8-6ae9-85a9-dab6-880e0f2b3810-a3c4f7b9 w-input" maxlength="256" name="Start-Time_YYYY" data-name="Start Time_YYYY" placeholder="YYYY" id="Start-Time_YYYY" required=""><input type="number" class="login-field duration-field w-node-_90aa041a-657e-3c34-3e14-d9994fc791ef-a3c4f7b9 w-input" maxlength="256" name="StartTime_HH" data-name="StartTime_HH" placeholder="HH" id="StartTime_HH-2" required=""><input type="number" class="login-field duration-field w-node-f3efc254-fee3-0567-2e27-4dfc1733d9a8-a3c4f7b9 w-input" maxlength="256" name="StartTime_MM" data-name="StartTime_MM" placeholder="MM" id="StartTime_MM-3" required=""><select id="daylight-field" name="Daylight" data-name="Daylight" required="" class="login-field daylight-field w-node-_6491fa5f-95e4-b6b0-5cac-208ac723fc15-a3c4f7b9 w-select">
              ...
              <div id="w-node-_2ac18de0-5515-bfe0-0005-1ab538d87c0f-a3c4f7b9" class="registration-divider tournament-divider"><label for="CheckIn_HH" class="field-label">Check-In Duration</label>
                <div class="w-layout-grid grid-5"><input type="number" class="login-field duration-field w-node-a9f71769-e1fe-6be3-4387-dcf19db52157-a3c4f7b9 w-input" maxlength="256" name="CheckIn_HH-2" data-name="Check In HH 2" placeholder="HH" id="CheckIn_HH-2" required=""><input type="number" class="login-field duration-field w-input" maxlength="256" name="CheckIn-MM" data-name="CheckIn-MM" placeholder="MM" id="CheckIn-MM" required=""></div>
              </div>
            </div>
