...
! function(t) {
    ...
    i.resize = _(u, E), i.scroll = _(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = _(), i.location = function(t) {
        ...
        t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (h = t.domready), d.each(r, m), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === k.state() && O()
        ...
        var M = e.frame = function() {
            ...
            P = l(function(e) {
                ...
                function h(t, e, i) {
                    var o, a, s, u, c = e !== p,
                        l = {};
                    for (o in t) s = t[o], o in Y ? (l.transform || (l.transform = {}), l.transform[o] = s) : (g.test(o) && (o = n(o)), o in K ? l[o] = s : (u || (u = {}), u[o] = s));
                    for (o in l) {
    ...
    n(5), n(8), n(9), n(10), n(11), n(12), n(13), n(14), n(16), n(21), t.exports = n(22)
}, function(t, e, n) {
    "use strict";
    var i = n(0);
    ...
    i.define("dropdown", t.exports = function(t, e) {
        ...
        function R() {
            n = d && i.env("design"), (u = O.find(p)).each(T)
        }
        ...
        function T(e, r) {
            ...
            n && l.el.on(A, function(t) {
                return function(e, n) {
                    n = n || {}, L(t), !0 === n.open && I(t), !1 === n.open && S(t, {
                        immediate: !0
                    })
                }
        ...
        function I(e) {
            if (!e.open) {
                ...
                var r = i.env("editor");
                n || O.on(E, e.mouseUpOutside), e.hovering && !r && e.el.on(k, e.mouseLeave), e.hovering && r && O.on(x, e.mouseMoveOutside), window.clearTimeout(e.delayId)
            }
        }
        ...
        function S(t) {
            ...
            if (t.open && (!t.config.hover || !t.hovering || i)) {
                ...
                var r = t.config;
                if (m.outro(0, t.el[0]), O.off(E, t.mouseUpOutside), O.off(x, t.mouseMoveOutside), t.el.off(k, t.mouseLeave), window.clearTimeout(t.delayId), !r.delay || n) return t.complete();
        ...
        function y(e, n) {
            ...
            r.done = a.find("> .w-form-done"), r.fail = a.find("> .w-form-fail"), r.fileUploads = a.find(".w-file-upload"), r.fileUploads.each(function(e) {
                ! function(e, n) {
                    ...
                    g || d.on("click keydown", function(t) {
                        "keydown" === t.type && 13 !== t.which && 32 !== t.which || (t.preventDefault(), l.click())
                    });
                    if (d.find(".w-icon-file-upload-icon").attr("aria-hidden", "true"), v.find(".w-icon-file-upload-remove").attr("aria-hidden", "true"), g) l.on("click", function(t) {
                        t.preventDefault()
                        ...
                        v.on("click keydown", function(t) {
                            ...
                            (i = r.target && r.target.files && r.target.files[0]) && (o.toggle(!1), c.toggle(!1), a.toggle(!0), a.focus(), m.text(i.name), R() || k(n), n.fileUploads[e].uploading = !0, function(e, n) {
                    ...
                    function _(t) {
                        var i = t.responseJSON && t.responseJSON.msg,
                            r = y;
                        "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = b : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = w), h.text(r), l.removeAttr("data-value"), l.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), c.focus(), n.fileUploads[e].uploading = !1, R() || x(n)
                    }
                    ...
                    function O(t) {
                        if (t) return _(t);
                        a.toggle(!1), s.css("display", "inline-block"), s.focus(), n.fileUploads[e].uploading = !1, R() || x(n)
                    }
            ...
            r.handler = null, r.redirect = i.attr("data-redirect"), w.test(c) ? r.handler = A : c || (o ? r.handler = "function" == typeof hostedSubmitWebflow ? hostedSubmitWebflow : _ : b())
        }
    ...
    i.define("navbar", t.exports = function(t, e) {
        ...
        function O(n, i) {
            ...
            c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), L(a), s ? (T(a), a.el.on("setting" + m, function(t) {
                return function(n, i) {
                    i = i || {};
                    var r = d.width();
                    L(t), !0 === i.open && F(t, !0), !1 === i.open && j(t, !0), t.open && e.defer(function() {
                        r !== d.width() && I(t)
                    })
                }
            }(a))) : (! function(e) {
    ...
    i.define("slider", t.exports = function(t, e) {
        ...
        function k(e, n) {
            ...
            r || (r = t.data(n, h, {
                ...
                el: i,
                config: {}
            })), r.mask = i.children(".w-slider-mask"), r.left = i.children(".w-slider-arrow-left"), r.right = i.children(".w-slider-arrow-right"), r.nav = i.children(".w-slider-nav"), r.slides = r.mask.children(".w-slide"), r.slides.each(g.reset), w && (r.maskWidth = 0), void 0 === i.attr("role") && i.attr("role", "region"), void 0 === i.attr("aria-label") && i.attr("aria-label", "carousel");
            ...
            c.addClass(m), w || M(e, n), a.removeClass(m), c.removeClass(m)
        }
        ...
        function A(e, n, i) {
            return function(r) {
                ...
                n ? (e.ariaLiveLabel.attr("aria-live", "polite"), e.hasTimer && C(e)) : (e.ariaLiveLabel.attr("aria-live", "off"), e.hasTimer && L(e))
            }
        }
            ...
            return function(r, a) {
                ...
                if (s && "setting" === r.type) {
                    ...
                    if ("swipe" === r.type) {
                        ...
                        return "left" === a.direction ? T(n)() : "right" === a.direction ? R(n)() : void 0
                    }
        ...
        function D(e, n) {
            ...
            var d = e.offsetX || 0,
                ...
                E = "opacity " + x + "ms " + y,
                _ = "transform " + x + "ms " + y;
            if (p.find(a).removeAttr("tabindex"), p.removeAttr("aria-hidden"), p.find("*").removeAttr("aria-hidden"), m.find(a).attr("tabindex", "-1"), m.attr("aria-hidden", "true"), m.find("*").attr("aria-hidden", "true"), s || (p.each(g.intro), m.each(g.outro)), n.immediate && !w) return l(p).set(h), void R();
        ...
        function N(e) {
            ...
            u < 0 && (u = 0), e.anchors = [{
                ...
                r && (r = parseFloat(r) + "px");
                for (var o = 0, a = e.pages; o < a; o++)(n = t(p)).attr("aria-label", "Show slide " + (o + 1) + " of " + a).attr("aria-pressed", "false").attr("role", "button").attr("tabindex", "-1"), e.nav.hasClass("w-num") && n.text(o + 1), null != r && n.css({
                    "margin-left": r,
                    "margin-right": r
                }), i.push(n);
