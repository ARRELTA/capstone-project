<?php
  session_start();
  include_once 'home/accounts/includes/functions.php';
?>
							...
							<?php
								if (isset($_SESSION["userName"])) {
									echo "<ul role='list' class='nav-menu-block w-list-unstyled'>
											  <li class='nav-menu-item'>
											  <a href='logout.php' class='nav-link-accent non-indicator-link'>Log Out</a>
											  <link rel='prerender' href='/accounts/logout'>";
										echo "</li>
											  <li class='mobile-margin-top-10'>
											  <a href='/home/accounts/register.php' class='button-primary w-button'>Profile</a>
