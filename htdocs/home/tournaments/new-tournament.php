...
<body class="body-a">
        ...
        <div class="form-block w-form">
          <form id="wf-form-Tourn-Create-Form" name="wf-form-Tourney-Creation-Form" data-name="Tourney Creation Form" method="post" action="../accounts/includes/tour_functions.php" class="form registration-form">
            <div class="w-layout-grid grid-3">
              ...
              <div id="w-node-_8103de59-c632-97d3-9531-640b9672d9a6-114d5da7" class="registration-divider tournament-divider"><label for="Tourney-Type" class="field-label">Type</label><select id="Tourney-Type" name="Tourney-Type" data-name="Tourney-Type" required="" class="select-field w-select" onchange="thing1()">
              ...
              <div id="w-node-_2ac18de0-5515-bfe0-0005-1ab538d87c0b-114d5da7" class="registration-divider tournament-divider"><label for="StartTime_HH" class="field-label">Start Time</label>
                <div class="w-layout-grid grid-4">
					<input type="number" class="login-field duration-field w-node-_2ac18de0-5515-bfe0-0005-1ab538d87c12-114d5da7 w-input" maxlength="256" name="StartTime_DD" data-name="StartTime_DD" placeholder="DD" id="StartTime_DD-2" required="" min="1" max="31">
					<input type="number" class="login-field duration-field w-node-c7c5ca6a-26eb-85a7-1e3e-d034b85d7bde-114d5da7 w-input" maxlength="256" name="StartTime_MM" data-name="StartTime_MM" placeholder="MM" id="StartTime_MM-2" required="" min="1" max="12">
					<input type="number" class="login-field year-field w-node-d37991c8-6ae9-85a9-dab6-880e0f2b3810-114d5da7 w-input" maxlength="256" name="StartTime_YYYY" data-name="Start Time_YYYY" placeholder="YYYY" id="Start-Time_YYYY" required="" min="2000" max="9999">
					<input type="number" class="login-field duration-field w-node-_90aa041a-657e-3c34-3e14-d9994fc791ef-114d5da7 w-input" maxlength="256" name="StartTime_HR" data-name="StartTime_HR" placeholder="HH" id="StartTime_HH-2" required="" min="1" max="24">
					<input type="number" class="login-field duration-field w-node-f3efc254-fee3-0567-2e27-4dfc1733d9a8-114d5da7 w-input" maxlength="256" name="StartTime_MIN" data-name="StartTime_MIN" placeholder="MM" id="StartTime_MM-3" required="" min="0" max="59">
					<select id="daylight-field" name="Daylight" data-name="Daylight" required="" class="login-field daylight-field w-node-_6491fa5f-95e4-b6b0-5cac-208ac723fc15-114d5da7 w-select">
						<option value>--</option>
              ...
              <div id="w-node-_2ac18de0-5515-bfe0-0005-1ab538d87c0f-114d5da7" class="registration-divider tournament-divider"><label for="CheckIn_HH" class="field-label">Check-In Duration</label>
                <div class="w-layout-grid grid-5">
					<input type="number" class="login-field duration-field w-node-a9f71769-e1fe-6be3-4387-dcf19db52157-114d5da7 w-input" maxlength="256" name="CheckIn-HH" data-name="CheckIn-HH" placeholder="HH" id="CheckIn_HH-2" required="" min="0">
					<input type="number" class="login-field duration-field w-input" maxlength="256" name="CheckIn-MM" data-name="CheckIn-MM" placeholder="MM" id="CheckIn-MM" required="" min="0" max="55" step="5">
				</div>
              </div>
            </div>
            <div class="single-elimination-controls" id="single_controls">
              <div class="registration-divider checkbox-div"><label class="w-checkbox checkbox-field w-clearfix">
                  <div class="w-checkbox-input w-checkbox-input--inputType-custom checkbox"></div><input type="checkbox" id="checkbox" name="thirdPlace" data-name="thirdPlace" style="opacity:0;position:absolute;z-index:-1"><span class="checkbox-label w-form-label" for="checkbox"><strong class="bold-text">Hold Third Place Match?</strong></span>
                </label></div>
            </div>
            <div class="double-elimination-controls" id="double_controls">
            ...
            <div class="round-robin-controls" id="robin_controls">
            ...
            <div class="swiss-controls" id="swiss_controls">
              <div class="w-layout-grid grid-6">
                ...
                <div class="registration-divider checkbox-div"><label for="Points-Match-Tie-S-2" class="field-label description-label">Points for Match Tie</label><input type="number" class="login-field number-field w-input" maxlength="256" name="Points Match Tie S" data-name="Points Match Tie S" placeholder="" id="Points-Match-Tie-S-2"></div>
            ...
            <div class="div-block-4 description-block">
				<label for="Tourney-Desc" class="field-label description-label">Description / Instructions</label><textarea id="Tourney-Desc" name="Tourney-Description" maxlength="5000" data-name="Tourney-Description" placeholder="Add your message or instructions here!" class="login-field description-field w-input"></textarea>
				</div>
				<div class="w-form-formrecaptcha recaptcha g-recaptcha g-recaptcha-error g-recaptcha-disabled g-recaptcha-invalid-key"></div>
				<input type="submit" data-wait="Wait..." name="CREATE" value="Submit" class="button-primary form-button w-button">
          </form>
  ...
  <script>
	// Hide all extra controls
	function hideControls() {
		var c0 = document.getElementById("single_controls");
		var c1 = document.getElementById("double_controls");
		var c2 = document.getElementById("robin_controls");
		var c3 = document.getElementById("swiss_controls");
		c0.style.display="none"; c1.style.display="none";
		c2.style.display="none"; c3.style.display="none";
	}
  </script>
  <script>function thing1() {var con = document.getElementById("Tourney-Type").value; alert(con);}
  <script>
	// Control show handling
	function showControls() {
		hideControls();
		var con = document.getElementById("Tourney-Type").value;
		var con2 = "";
		switch (con) {
			case "single elimination": con2 = document.getElementByClassName("single-elimination-controls"); break;
			case "double elimination": con2 = document.getElementByClassName("double-elimination-controls"); break;
			case "round robin": con2 = document.getElementByClassName("round-robin-controls"); break;
			case "swiss": con2 = document.getElementByClassName("swiss-controls"); break;
			case default: break;
		}
